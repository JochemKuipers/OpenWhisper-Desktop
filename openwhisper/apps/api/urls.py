...
urlpatterns = [
    ...
    path(
        "auth/session-token/", SessionTokenAPIView.as_view(), name="api-session-token"
    ),
    ...
    path(
        ...
        FriendRequestsAPIView.as_view(),
        name="friend-requests",
    ),
    path(
        "users/me/friends/<str:username>/",
        MeFriendDetailAPIView.as_view(),
        name="me-friend-detail",
    ),
    ...
    path(
        "chats/<int:chat_id>/invite/", ChatInviteAPIView.as_view(), name="chat-invite"
    ),
    path(
